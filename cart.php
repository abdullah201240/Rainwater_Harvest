...
<div class="preloader">
    ...
    <div class="page">
        ...
        <a 
                                    ...
                                    href="useraddress.php" data-caption-animate="fadeInUp" data-caption-delay="300">Add Delivery Address</a>
          <br><br>  <br> 
...
<from method = "POST">
<div >
<button style="background-color:#1165D4; color: balck; height: 60px; weight: 200px;" type="button" name="payment"><a href="amountCountAPI.php"><h6>Payment</h6></a></button>
  </form>
<Br><Br>
</div>
                ...
                <div class="group-xmd group-sm-justify">
                  ...
                  <div class="footer-modern-contacts wow slideInDown">
                    <div class="unit unit-spacing-sm align-items-center">
                      ...
                      <div class="unit-body"><a class="mail" href="mailto:#">rainwh@gmail.com</a></div>
                    </div>
                  </div>
