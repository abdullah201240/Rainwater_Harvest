                ...
                <div class="row row-lg row-30">
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <article style="background-color: #A3D0F3;" class="product wow fadeInLeft" data-wow-delay=".15s">
                            ...
                            <div class="product-price-wrap">
                                <div style="color: blue;" class="product-price">500Tk Per Gallon</div>
                            </div> 
                    ...
                    <div class="col-sm-6 col-lg-4 col-xl-3">
                        ...
                        <article style="background-color: #A3D0F3;" class="product wow fadeInLeft" data-wow-delay=".15s">
                            ...
                            <div class="product-price-wrap">
                                <div style="color: blue;" class="product-price">350Tk Per Gallon</div>
                            </div> 
...
<article style="background-color: #A3D0F3;" class="product wow fadeInLeft" data-wow-delay=".15s">
                            ...
                            <div class="product-price-wrap">
                                <div style="color: blue;" class="product-price">200Tk Per Gallon</div>
                            </div> 
