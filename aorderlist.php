...
<div class="preloader">
                                        ...
                                        <li>
                                            <div class="unit unit-spacing-xs">
                                                ...
                                                <div class="unit-body"><a class="address"
                                                        href="https://www.google.com/maps/place/Gulshan,+Dhaka/@23.7897077,90.3929248,14z/data=!3m1!4b1!4m5!3m4!1s0x3755c7a0f70deb73:0x30c36498f90fe23!8m2!3d23.7924961!4d90.4078058"><?php echo "CompanyADDRESS"; ?></a></div>
                                            </div>
                                        </li>
                                    

                                        <li>
                                        <button type="button"  style= "background-color: white;" style="color:black;" class="btn btn-outline-info"><p style=" font-size:20px;"><a href="alogout.php">Logout  </p></button>
                                        </li>
  ...
  <?php 
    ...
    <td> $gallons </td> <td> $type</td><td>$status</td><td><a href='orderStatusAPI.php?Order_No=$orderno'><button>Delivered</button> </a></td></tr>" ;
